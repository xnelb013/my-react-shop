...
const Footer = () => {
  ...
  return (
    <footer className={`${styled.footerContainer} relative w-full`}>
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography variant="small" className="mb-4 text-center font-normal text-blue-gray-900 md:mb-0">
            &copy; {currentYear} <a href="#">eunseok zerobase</a>. All Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            <Typography as="a" href="#" aria-label="임시" className="opacity-80 transition-opacity hover:opacity-100">
